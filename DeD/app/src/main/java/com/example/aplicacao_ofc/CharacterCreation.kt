    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun verifyInfo() : Boolean {
            ...
            if (validateName(nome_escolhido)){
                ...
                Toast.makeText(this, "Nome inválido. Use apenas 3 e 12 caracteres.", Toast.LENGTH_SHORT).show()
                return false
            }
        }
        ...
        continuar.setOnClickListener {
            when {
                ...
                isDLClicked -> {
                    ...
                    Toast.makeText(this, "Por favor, selecione uma distribuição ", Toast.LENGTH_SHORT).show()
                }
            }
        }
